package com.example.todosampleapp.feature.tododetail.entry
...
import com.example.todosampleapp.feature.tododetail.presentation.TodoDetailViewModel
import com.example.todosampleapp.feature.tododetail.ui.TodoDetailScreen
import kotlinx.serialization.Serializable

/**
 * Todo 詳細画面の Route。
 * プロパティ名 `id` は presentation 側の TODO_DETAIL_ID_ARG と一致させる必要がある。
 */
@Serializable
